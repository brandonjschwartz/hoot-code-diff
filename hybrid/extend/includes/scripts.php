...
/* Optional: Since we dont need any of the framework scripts (mobile-toggle), we can remove this action. This file is loaded at priority 2 while framework scripts is loaded at -95, so its ok to remove action here. */
remove_action( 'wp_enqueue_scripts', 'hybrid_register_scripts', 0 );
